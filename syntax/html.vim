...
syn keyword htmlTagName contained dialog mark time progress meter 
syn keyword htmlTagName contained figure video audio souce canvas 
syn keyword htmlTagName contained datalist output details command bb menu
